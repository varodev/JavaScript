        ...
        if (miAjax.readyState == 4) {
            if (miAjax.status == 200) {
                ...
                for (let i = 0; i < titulos.length; i++) {
                    //Creamos todos los elementos para meter los datos
                    ...
                    let AnoEdicionh3 = document.createElement("h2")
                    AnoEdicionh3.innerHTML = "Año de edición"
                    ...
                    Descripcionh3.innerHTML = "Descripción"
